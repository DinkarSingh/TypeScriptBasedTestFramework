...
if (process.env.HEADLESS) {
    googleOptions.args = ['--headless', '--disable-gpu', '--window-size=1920,1080']
}

//different environments details
if (!ENV || !['preprod', 'prod'].includes(ENV)) {
    console.log('please pass the env');
    process.exit();
}

const drivers = {
    chrome: { version: '2.44' }// https://chromedriver.chromium.org/
}
...
exports.config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': googleOptions,
    ...
    baseUrl: envUrls[process.env.ENV],
    //
